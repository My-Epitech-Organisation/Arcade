...
const std::unordered_map<Keys, sf::Keyboard::Key> SFMLKeyMap::_keyMap = {
    ...
    {Keys::NUM0, sf::Keyboard::Numpad0},
    {Keys::NUM1, sf::Keyboard::Numpad1},
    {Keys::NUM2, sf::Keyboard::Numpad2},
    {Keys::NUM3, sf::Keyboard::Numpad3},
    {Keys::NUM4, sf::Keyboard::Numpad4},
    {Keys::NUM5, sf::Keyboard::Numpad5},
    {Keys::NUM6, sf::Keyboard::Numpad6},
    {Keys::NUM7, sf::Keyboard::Numpad7},
    {Keys::NUM8, sf::Keyboard::Numpad8},
    {Keys::NUM9, sf::Keyboard::Numpad9},
