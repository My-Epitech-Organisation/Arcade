...
void NCursesColor::initColorPairs() {
    ...
    if (!stdscr) {
        std::cerr << "Cannot initialize colors: NCurses not initialized" <<
            std::endl;
        return;
    }
    if (has_colors()) {
        ...
        try {
            // Standard colors
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::RED),
                      COLOR_RED, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::GREEN),
                      COLOR_GREEN, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::BLUE),
                      COLOR_BLUE, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::YELLOW),
                      COLOR_YELLOW, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::MAGENTA),
                      COLOR_MAGENTA, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::CYAN),
                      COLOR_CYAN, COLOR_BLACK);

            // Colors that need approximation in NCurses
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::ORANGE),
                      COLOR_YELLOW, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::BROWN),
                      COLOR_RED, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::GREY),
                      COLOR_WHITE, COLOR_BLACK);

            // Basic colors
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::WHITE),
                      COLOR_WHITE, COLOR_BLACK);
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::BLACK),
                      COLOR_BLACK, COLOR_BLACK);

            // Special case for no color
            init_pair(COLOR_PAIR_OFFSET +
                static_cast<int>(Arcade::Color::NOCOLOR),
                      COLOR_WHITE, COLOR_BLACK);
...
int NCursesColor::convertColor(Arcade::Color color) {
    ...
    if (color < Arcade::Color::RED || color > Arcade::Color::NOCOLOR) {
        ...
        return COLOR_PAIR(COLOR_PAIR_OFFSET +
            static_cast<int>(Arcade::Color::WHITE));
    }
